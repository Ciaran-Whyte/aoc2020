...
def is_password_valid(min_count: int, max_count: int, character: str, password: str) -> bool:
    # print(f"{character} {password}")
    # print(f"{min_count} <= {password.count(character)} <= {max_count}")
